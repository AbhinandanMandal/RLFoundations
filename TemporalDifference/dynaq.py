...
class DynaQ:
    ...
    def update(self, state, action, reward, next_state):
        ...
        for _ in range(self.n_planning):
            (past_state, past_action), (past_reward,
                                        past_next_state) = random.choice(list(self.model.items()))
            self.q_learning(past_state, past_action,
                            past_reward, past_next_state)
